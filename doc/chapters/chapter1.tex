...
\section{Knowledge graph in using Python}

Networkx \parencite{hagberg2008exploring} and Pandas \parencite{mckinney2010data} are python libraries for working with graphs and data structures.